 ...
 * @see FooModel
 * @see fooSb.model.impl.FooImpl
 * @see fooSb.model.impl.FooModelImpl
 * @generated
 */
@ImplementationClassName("fooSb.model.impl.FooImpl")
@ProviderType
public interface Foo extends FooModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link fooSb.model.impl.FooImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
